...
static void cliReboot( char *cmdline) ;
...
{
    (void)cmdline;
    cliPrint("CAN OSD CLI version 1.1 " __DATE__ " / " __TIME__);
}
...
//		{ "imu_broadcast_time", VAR_UINT16, &mcfg.imu_boradcast_ms, 10, 1000},	
//		{ "imu_broadcast_en", VAR_UINT8, &f.IMU_BROADCAST, 0, 1},
